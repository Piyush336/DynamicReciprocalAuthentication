			...
			<div id="logo">
				<div id="logo_text">
					<br /> <br /> <font size="5"><a href="index.html"><span
							class="logo_colour">Dynamic Reciprocal Authentication
								Protocol for Mobile Cloud Computing </span></a></font>
				</div>
			</div>
			<div id="menubar">
				<ul id="menu">
			...
			<div id="content">
				...
				<div class="form_settings">
					<form action="loginaction.jsp" name="ff" method="get"
						...
						<p>
							<span>Name</span><input class="contact" type="text" name="user"
